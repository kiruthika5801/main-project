                    ...
                    <Row className="shop-boxOne  ">
                        <Col className="d-flex justify-content-center" lg={4} md={4} sm={4}>
                            <Card className="card-sWhite">
                                ...
                                <Card.Body>
                                    <Card.Title className="card-Shead">Flower Decor</Card.Title>
                        ...
                        <Col className="d-flex justify-content-center" lg={4} md={4} sm={4}>
                            <Card className="card-sWhite">
                                ...
                                <Card.Body>
                                    <Card.Title className="card-Shead">Wedding Arch</Card.Title>
                        ...
                        <Col className="d-flex justify-content-center" lg={4} md={4} sm={4} >
                            <Card className="card-sWhite" >
                                ...
                                <Card.Body>
                                    <Card.Title className="card-Shead">Table Centerpiece</Card.Title>
                    ...
                    <Row className="shop-boxTwo  ">
                        <Col className="d-flex justify-content-center" lg={4} md={4} sm={4} >
                            <Card className="card-sWhite">
                                ...
                                <Card.Body>
                                    <Card.Title className="card-Shead">Wedding Bouquet</Card.Title>
                        ...
                        <Col className="d-flex justify-content-center" lg={4} md={4} sm={4} >
                            <Card className="card-sWhite">
                                ...
                                <Card.Body>
                                    <Card.Title className="card-Shead">Wedding Candles</Card.Title>
                        ...
                        <Col className="d-flex justify-content-center" lg={4} md={4} sm={4}>
                            <Card className="card-sWhite" >
                                ...
                                <Card.Body>
                                    <Card.Title className="card-Shead">Wedding Lighted Signs</Card.Title>
